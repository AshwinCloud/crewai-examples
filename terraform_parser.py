...
def analyze_terraform_project(terraform_directory: str) -> List[str]:
...
if __name__ == "__main__":
    ...
    terraform_dir = "/Users/ash/Sandbox/llm/crew/terraform-project"
    # if len(sys.argv) > 1:
    #     terraform_dir = sys.argv[1]
    # else:
    #     terraform_dir = input("Enter the path to the Terraform project directory: ")

    resource_list = analyze_terraform_project(terraform_dir)
